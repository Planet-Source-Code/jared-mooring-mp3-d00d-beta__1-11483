Attribute VB_Name = "basFileAssociation"
...
'3. BackupAssoc - to dump an association to a registry entries file (.REG file)
'4. RestoreAssoc - to restore association from a .REG file
